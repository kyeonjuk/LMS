                ...
                <div id="Sub840_con">
                    ...
                    <div class="wrapcustomer">
                        ...
                        <div class="cont_tit_type1 cont_tit_type1_1">
                            <strong class="tit">강사 등록</strong>

                        </div>

                        <!--//cont -->

                        <form action="/admin/teacher-add-pro" method="post" enctype="multipart/form-data">
                                ...
                                <table width="100%" class="tbl cstbl_input_st1 mt_10">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <input name="password" type="password" class="csinp_txt"
                                                    style="width:655px;" maxlength="200">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>핸드폰 번호</th>
                                            <td colspan="4">
                                                <input name="phone" type="text" class="csinp_txt" style="width:655px"
                                                    maxlength="200" placeholder="01000000000">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <input name="birth" type="text" class="csinp_txt" style="width:655px"
                                                    maxlength="200" placeholder="2000-00-00">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th>이미지</th>
                                            <td colspan="4">
                                                <input type="file" style="height: 25px;" />
                                            </td>
                                        </tr>
