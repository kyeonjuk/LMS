					...
					<div id="wrapmyroom">
						<div class="wr_cont_f my_lectroom">
							...
							<div class="cont_tit_type1 cont_tit_type1_1">
								<strong class="tit">강의 패키지 관리</strong>
							...
							<div class="list_t_sort">
								<span>
									<a href="/admin/course-add" style="display: inline-block;
                                    width: 100px;
								...
								<li th:each="course : ${courseList}" id="lectureStudyView_nor">
									...
									<div class="wr_listcont">
										...
										<div style="margin-bottom: 10px;">
											<span style="font-size: 20px; color: #086d95; font-weight: 600;" th:text="${course.title}"></span>
										</div>
										...
										<!-- 수정 / 삭제 버튼 -->
										<span>
											<a th:href="@{'/admin/course-update/' + ${course.id}}" style="display: inline-block;
                                            width: 100px;
										...
										<span>
											<a th:href="@{'/admin/course-delete/' + ${course.id}}" style="display: inline-block;
                                            width: 100px;
							...
							<div class="lect_paging mt_20">
								<span class="page">
									<span th:each="pageNum : ${pageList}">
										<a th:href="@{/admin/course-list(page=${pageNum-1}, sortName=${sortName}, sort=${sort})}"
											th:text="${pageNum}"
